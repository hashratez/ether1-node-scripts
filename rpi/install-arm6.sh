...
wget https://github.com/Ether1Project/Ether-1-SN-MN-Binaries/releases/download/1.3.0/Ether1-MN-SN-1.3.0-arm6.zip

unzip Ether1-MN-SN-1.3.0-arm6.zip

# Make node executable
chmod +x geth

# Remove and cleanup
rm Ether1-MN-SN-1.3.0-arm6.zip
